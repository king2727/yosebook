...
function loadChildren() {
	...
	$.ajax({
		async:true,
		cache:false,
		url:"/yosebook-ssm-maven/admin/book/ajaxFindChildren.do",
		data:{pid:pid},
		type:"POST",
		dataType:"json",
...
function editForm(){
	$("#form").attr("action", "/yosebook-ssm-maven/admin/book/edit.do");
	$("#form").submit();
}
function delForm(){
	$("#form").attr("action", "/yosebook-ssm-maven/admin/book/delete.do");
	$("#form").submit();
}
</script>
  </head>
